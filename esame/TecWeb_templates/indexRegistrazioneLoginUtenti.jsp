      ...
      -->
		...
		<div>
			...
			<form action="Registration" method="post">
				<input type="text" size="20" name="userName" hint="insert the username" required><br>
				<input type="text" size="20" name="password" hint="insert the your pwd" required><br>
				<input type="text" size="7" name="gruppo" hint="insert the group" required><br>
		...
		<div>
			<%String err=(String)session.getAttribute("err"); if(err!=null) { int codiceErr=Integer.parseInt(err);
				switch(codiceErr) { case 1: { %>
				...
				<% }break; case 2: { %>
					...
					<% }break; case 3: { %>
						...
						<% }break; case 4: { %>
							<p><b> Errore: Nel Gruppo selezionato ci sono almeno 3 password scadute, cambiare la propria
									presso la pagina registration</b></p>
							<% }break; case 5: { %>
