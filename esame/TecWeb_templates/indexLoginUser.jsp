	...
	<body>
      ...
      -->
		...
		<div>
			...
			<% Integer result=(Integer)session.getAttribute("success"); if(result !=null) { switch(result) { case 1: {
				%>
				<p>Ordine finalizzato con <strong>successo</strong> da parte sua, si attendono gli altri elementi del
					gruppo</p>
				<% }break; case 2: { %>
					<p>Tutti gli elementi del gruppo hanno finalizzato l'ordine: Ordine finalizzato con
